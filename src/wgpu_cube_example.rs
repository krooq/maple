...
impl App {
    fn generate_matrix(aspect_ratio: f32) -> cgmath::Matrix4<f32> {
        ...
        let mx_correction = app::OPENGL_TO_WGPU_MATRIX;
...
impl app::App for App {
    fn init(
        ...
        let vs_bytes = include_bytes!("shader/cube/shader.vert.spv");
        let fs_bytes = include_bytes!("shader/cube/shader.frag.spv");
