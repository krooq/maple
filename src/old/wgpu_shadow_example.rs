...
#[path = "wgpu_framework_example.rs"]
mod framework;
...
impl framework::Example for Example {
    fn init(
        ...
        let shadow_pass = {
            ...
            let vs_bytes = include_bytes!("shader/bake.vert.spv");
            let fs_bytes = include_bytes!("shader/bake.frag.spv");
        ...
        let forward_pass = {
            ...
            // Create the render pipeline
            let vs_bytes = include_bytes!("shader/forward.vert.spv");
            let fs_bytes = include_bytes!("shader/forward.frag.spv");
            let vs_module = device.create_shader_module(
                &wgpu::read_spirv(std::io::Cursor::new(&vs_bytes[..])).unwrap(),
            );
            let fs_module = device.create_shader_module(
